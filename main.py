...
def extract_data(directory, test):
    docs = [Document.from_file(os.path.join(directory, filename), test)
...
def tune(x_train, y_train, x_test, y_test):
    for c1 in [1e-3, 1e-2, 1e-1, 1, 10, 100]:
        for c2 in [1e-3, 1e-2, 1e-1, 1, 10, 100]:
            for possible_transitions in [True, False]:
                ...
                train(x_train, y_train, c1=c1, c2=c2, max_iterations=1000, possible_transitions=possible_transitions)
